...
public partial class PictureService : IPictureService
{
    ...
    /// </returns>
    public async Task<ProductPictureDto> GetFirstPictureByProductIdAsync(int productId)
    {
        ...
        var picture = await GetPictureByIdAsync(mapping.PictureId);
        if (picture == null)
            return null;

        return new ProductPictureDto
        {
            ProductPictureId = mapping.Id,
            PictureId = mapping.PictureId,
